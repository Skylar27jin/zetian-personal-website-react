...
export default function SignupPage() {
  ...
  const primaryAction =
    step === 1
      ? { text: loading ? "Sending..." : "Send verification code", onClick: handleSendCode }
      : step === 2
      ? { text: loading ? "Verifying..." : "Verify code", onClick: handleVerifyCode }
